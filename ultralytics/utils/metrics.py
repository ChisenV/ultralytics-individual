...
def bbox_iou_v2(
    ...
    Returns:
        Intersection over Union (IoU) of box1(1,4) to box2(n,4)
    """
    ...
    if CIoU or DIoU or GIoU or EIoU or SIoU or WIoU:
        ...
        if CIoU or DIoU or EIoU or SIoU or WIoU:  # Distance or Complete IoU https://arxiv.org/abs/1911.08287v1
            ...
            if CIoU:  # https://github.com/Zzh-tju/DIoU-SSD-pytorch/blob/master/utils/box/box_utils.py#L47
                ...
                # Focal and Efficient IOU Loss http://arxiv.org/abs/2101.08158
                rho_w2 = ((b2_x2 - b2_x1) - (b1_x2 - b1_x1)) ** 2  # (rho(w, w^gt))^2
                rho_h2 = ((b2_y2 - b2_y1) - (b1_y2 - b1_y1)) ** 2  # (rho(h, h^gt))^2
                cw2 = torch.pow(cw ** 2 + eps, alpha)  # (cw)^2
                ch2 = torch.pow(ch ** 2 + eps, alpha)  # (ch)^2
                if Focal:
                    return (iou - (rho2 / c2 + rho_w2 / cw2 + rho_h2 / ch2),
                            torch.pow(inter / (union + eps), gamma))  # Focal_EIou
                else:
                ...
                if Focal:
                    ...
                    return getattr(WIoUScale, '_scaled_loss')(self), (1 - iou) * torch.exp(
                        (rho2 / c2.detach())), iou  # (r, WIoU v1, iou)
                else:
                    return iou, torch.exp((rho2 / c2.detach()))  # WIoU v1
            if Focal:
